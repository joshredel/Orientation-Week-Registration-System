...
<Response>
    ...
    <?= $playingString ?>
    <Gather numDigits="1" action="/twiliointest/phone/ostaff/handleLocation.php?message=<?= urlencode($textingString) ?>">
    	<!--
    	<Say>
    ...
    <Redirect>/twiliointest/phone/ostaff/location.php</Redirect>
    <? } else { ?>
