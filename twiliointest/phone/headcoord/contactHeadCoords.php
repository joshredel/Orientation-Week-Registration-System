...
<Response>
    <Gather numDigits="1" action="/twiliointest/phone/headcoord/handleContactHeadCoords.php">
    	<Say>
    ...
    <Redirect>/twiliointest/phone/headcoord/contactHeadCoords.php</Redirect>
</Response>