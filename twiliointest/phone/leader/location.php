...
<Response>
    ...
    <?= $playingString ?>
    <Gather numDigits="1" action="/twiliointest/phone/leader/handleLocation.php?message=<?= urlencode($textingString) ?>">
    	<!--
    	<Say>
    ...
    <Redirect>/twiliointest/phone/leader/location.php</Redirect>
    <? } else { ?>
