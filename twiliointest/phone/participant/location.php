...
<Response>
    ...
    <?= $playingString ?>
    <Gather numDigits="1" action="/twiliointest/phone/participant/handleLocation.php?message=<?= urlencode($textingString) ?>">
    	<!--
    	<Say>
    ...
    <Redirect>/twiliointest/phone/participant/location.php</Redirect>
    <? } else { ?>
