...
switch($digits) {
	...
	case 1:
        ...
        <Response>
            ...
            <Record action="/twiliointest/phone/coord/handleContactCoordsRecording.php"  finishOnKey="#" />
	...
	case 2:
        ...
        <Response>
            ...
            <Record action="/twiliointest/phone/coord/handleContactCoordsConference.php"  finishOnKey="#" />
            <Say>You did not record anything.</Say>
            <Redirect>/twiliointest/phone/coord/</Redirect>
        </Response>
        <?
	...
	case "9":
		header("location:/twiliointest/coord/contactHeadCoords.php");
		break;
