...
if($caller != null) {
	...
	redirect("/twiliointest/sms/participant/");
} else {
...
if($caller == null) {
	...
	redirect("/twiliointest/sms/general/");
}
...
switch($caller->classification) {
	case org\fos\User::LEADER:
		redirect("/twiliointest/sms/leader/");
		break;
	case org\fos\User::OSTAFF:
		redirect("/twiliointest/sms/ostaff/");
		break;
	case org\fos\User::COORDINATOR:
		redirect("/twiliointest/sms/coord/");
		break;
	case org\fos\User::HEAD_COORDINATOR:
		redirect("/twiliointest/sms/headcoord/");
		break;
