...
// get the group
$groupNumber = (int)$_REQUEST['group'];
...
?>
<Response>
	<Sms>Your message is being sent to all leaders of group <?= $groupNumber ?>.  You will receive confirmation when complete.</Sms>
</Response>
<?
...
try {
	...
	$message = $client->account->sms_messages->create($numberFrom, $caller->phoneNumber, "Your mass text to all leaders of group $groupNumber was sent successfully to $successCount people.", array("StatusCallback" => "http://orientation.ssmu.mcgill.ca/twiliointest/sms/textback.php"));
	$successCount++;
} catch (Exception $e) {
	$errors[] = $e;
	$errorCount++;
...
// send debugger email
mail("joshredel@mac.com", "Twilio: Head Coord to Group Texting Info", "Tried: $triedCount\nSuccesses: $successCount\nFailuers: $errorCount\nGroup: $groupNumber\nEvent name: " . $currentEvent->eventName . "\nThe following errors occured:\n " . implode("\n", $errors));
?>