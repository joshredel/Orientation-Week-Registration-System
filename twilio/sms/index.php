...
if($caller != null) {
	...
	redirect("/twilio/sms/participant/");
} else {
...
switch($caller->classification) {
	case org\fos\User::LEADER:
		redirect("/twilio/sms/leader/");
		break;
	case org\fos\User::OSTAFF:
		redirect("/twilio/sms/ostaff/");
		break;
	case org\fos\User::COORDINATOR:
		redirect("/twilio/sms/coord/");
		break;
	case org\fos\User::HEAD_COORDINATOR:
		redirect("/twilio/sms/headcoord/");
		break;
