...
try {
	...
	$message = $client->account->sms_messages->create($numberFrom, $caller->phoneNumber, "Your mass text to all $plural was sent successfully to $successCount people.", array("StatusCallback" => "http://orientation.ssmu.mcgill.ca/twilio/sms/textback.php"));
	$successCount++;
} catch (Exception $e) {
	$errors[] = $e;
	$errorCount++;
...
// send debugger email
mail("joshredel@mac.com", "Twilio: Coord to Staff Texting Info", "Tried: $triedCount\nSuccesses: $successCount\nFailuers: $errorCount\nClassification: $classification\nEvent name: " . $currentEvent->eventName . "\nThe following errors occured:\n " . implode("\n", $errors));
?>