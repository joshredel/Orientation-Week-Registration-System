...
switch($digits) {
	...
	case 1:
        ...
        <Response>
            ...
            <Record action="/twilio/phone/headcoord/handleContactCoordsRecording.php"  finishOnKey="#" />
	...
	case 2:
        ...
        <Response>
            ...
            <Record action="/twilio/phone/headcoord/handleContactCoordsConference.php"  finishOnKey="#" />
            <Say>You did not record anything.</Say>
            <Redirect>/twilio/phone/headcoord/</Redirect>
        </Response>
        <?
