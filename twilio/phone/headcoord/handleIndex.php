...
switch($digits) {
	case 1:
		header("location:/twilio/phone/headcoord/contactParticipants.php");
		break;
	case 2:
		header("location:/twilio/phone/headcoord/contactStaff.php?classification=" . urlencode("Leader"));
		break;
	case 3:
		header("location:/twilio/phone/headcoord/contactStaff.php?classification=" . urlencode("O-Staff"));
		break;
	case 4:
		header("location:/twilio/phone/headcoord/contactCoords.php");
		break;
	case 5:
		header("location:/twilio/phone/headcoord/contactHeadCoords.php");
		break;
	case 6:
	...
	case 7:
		...
		break;
	case 8:
		header("location:/twilio/phone/headcoord/feedback.php");
		break;
	case 0:
	default:
