	...
	if($caller->livingStyle == "InRez") {
		...
		if($caller->froshAddress != null && $caller->froshAddress != "" && $caller->froshAddress != "" && 
		   $caller->froshAddress != "Varcity515" && $caller->froshAddress != "Greenbriar") {
			   ...
			   redirect("/twilio/phone/common/connectFloorFellow.php?destination=" . $caller->froshAddress);
		}
	}
}
...
<Response>
    <Gather numDigits="1" action="/twilio/phone/common/handleFloorFellow.php">
    	<!--
        <Say>
