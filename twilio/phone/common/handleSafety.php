...
switch($digits) {
	case 1:
		header("location:/twilio/phone/common/connectSafety.php?destination=WalkSafe");
		break;
	case 2:
		header("location:/twilio/phone/common/connectSafety.php?destination=DriveSafe");
		break;
	case 3:
		header("location:/twilio/phone/common/connectSafety.php?destination=SACOMSS");
		break;
	case 4:
		header("location:/twilio/phone/common/connectSafety.php?destination=McGillSecurity");
		break;
	case 5:
		header("location:/twilio/phone/common/connectSafety.php?destination=Nightline");
		break;
	case 9:
		header("location:/twilio/phone/common/leader/safety.php");
		break;
	case 0:
