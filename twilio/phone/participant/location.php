...
<Response>
    ...
    <?= $playingString ?>
    <Gather numDigits="1" action="/twilio/phone/participant/handleLocation.php?message=<?= urlencode($textingString) ?>">
    	<!--
    	<Say>
    ...
    <Redirect>/twilio/phone/participant/location.php</Redirect>
    <? } else { ?>
    <Say>You have no events in your calendar for today.</Say>
    <Redirect>/twilio/phone/participant/</Redirect>
    <? } ?>
</Response>