...
<body> 
	...
	<div class="content">
	    ...
	    <div class="header">
	        ...
	        <h1 class="page-title">myWeek Dashboard</h1>
	    </div>
	    	...
	    	<div class="container-fluid">
				...
				<div class="row-fluid">
	            	<div class="block span6">
                    	<p class="block-heading">Group Information</p>
	              		<div class="block-body">
                            <?
                            if($participant->groupNumber != null && $participant->groupNumber != "") {
                            	$groupBreakdown = explode("::", $participant->groupNumber);
								$staffService = new services\StaffService();$staffs = $staffService->getStaffInGroup($groupBreakdown[0], $groupBreakdown[1]);
								echo("<h3>Group Information</h3>");
								echo("<p><strong>Group #" . $groupBreakdown[1] . "</strong></p>");
								echo("<p><strong>Leaders:</strong></p><ul>");
								...
								?>
                            	<p>You are not part of a frosh group.  If you are doing a faculty frosh, make sure to have your leader add you via their myWeek page.</p>
								<? 
							} ?>
                        </div>         
                    </div>  
	            	...
	            	<div class="block span6">
                    	<p class="block-heading">
                            ...
                            <span class="block-icon pull-right">
                            	<a href="webcal://orientation.ssmu.mcgill.ca/myweek/vcal.php?passkey=<?= $_GET['passkey'] ?>" rel="tooltip" title="Sync this calendar with your device"><i class="icon-download-alt"></i>Sync</a>
                            </span>
