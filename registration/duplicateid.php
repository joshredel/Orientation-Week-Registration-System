    	...
    	<div class="container">
        	<div class="row-fluid">
            	<div class="well span8 offset2 sign-up">
                	<form method="POST" class="form-horizontal" action="/actions/registration/processDuplicateId.php">
                        ...
                        <p>Otherwise, please make sure to return to <a href="/registration/step2.php">Step 2</a> to double check the student ID number you entered.</p>
                    </form>
                </div><!--End Span8-->
            </div><!--End Row-->
	    </div><!--End Container-->
