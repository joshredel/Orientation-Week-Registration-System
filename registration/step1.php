    	...
    	<div class="container">
        	<div class="row-fluid">
            	<div class="well span6 offset3 text-center sign-up">
                	<form method="POST" class="form-horizontal" action="/actions/registration/processStep1.php">
                        <ul class="breadcrumb">
                        	<li class="active">
                        ...
                        <p>If at any point along the way you need more help than what is provided, please do not hesitate to <a href="../registration/contact.html">contact us</a> for help!  Starting university can be a whirlwind experience, so we totally understand if something doesn't quite make sense or if you have any question whatsoever.</p><br />
