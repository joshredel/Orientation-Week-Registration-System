        ...
        <div class="container">
			<div class="row-fluid">
                <div class="span12">
                    ...
                    <p>Scan through each category to learn about each and every event available to you.  Some events are an absolute must, while other categories let you choose what fits you most!  Once you've finished browsing here, you can register for the events you want to attend.</p><br />
                </div>
            </div>
            <?
			...
			//} else {
				...
				$selectedFaculty = "AS";//$_POST['studentFaculty'];
				$selectedLivingStyle = "InRez";//$_POST['studentRez'];
				$selectedOrigin = "International";//$_POST['studentOrigin'];
            ?>
            <div class="row-fluid">
                <div class="span12">
                    <form method="POST" class="form-horizontal">
                        <div class="control-group">
                        	<div>
                                ...
                                <button type="submit" class="btn m-btn">Reset my selection!</button>
                            </div>
                        </div>
                	</form>
                </div>
                    ...
                    <div class="accordion" id="eventsAccordian">
                        ...
                        <div class="accordion-group master-event-group">
                            ...
                            <div id="discovermcgill" class="accordion-body collapse">
                            	<div class="accordion-inner">
                                	...
                                	<?
                                    printCategoryEvents(org\fos\Event::DISCOVER_MCGILL);
									?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-group master-event-group">
                            ...
                            <div id="oohlala" class="accordion-body collapse">
                            	<div class="accordion-inner">
                                	<?
                                    printCategoryEvents(org\fos\Event::OOHLALA);
									?>
                                </div>
                            </div>
                        </div>
