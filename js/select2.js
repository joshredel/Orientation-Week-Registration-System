...
(function ($, undefined) {
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        deleteEvent: function(val) {
        	//alert(val);
        	/*var choice;
			
			choice = this.
            this.select.addClass("select2-disabled");*/
    ...
    $.fn.select2 = function () {
        ...
        var args = Array.prototype.slice.call(arguments, 0),
            opts,
            select2,
            value, multiple, allowedMethods = ["deleteEvent", "val", "loadValue", "destroy", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable"];
        ...
        this.each(function () {
            if (args.length === 0 || typeof(args[0]) === "object") {
                ...
                } else if (args[0] === "loadValue") {
                	//select2 = new MultiSelect2();
                	select2.loadValue(args[1]);
                } else if (args[0] === "deleteEvent") {
                	//select2 = new MultiSelect2();
                	select2.deleteEvent(args[1]);
                } else {
