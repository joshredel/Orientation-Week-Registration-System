...
<html lang="en"><head>
	<meta charset="utf-8">
	<title>McGill Orientation Week 2013 | Select Payment | Complete</title>
    	...
    	<div class="container">
        	<div class="row-fluid">
            	<div class="well span6 offset3 sign-up">
					...
					if($status == "completed") {
					?>
                        <h2 class="text-center">myWeek<br />Payment<br />Complete!</h2>
                        <p class="lead">You're payment was completed successfully!  We're done.</p>
                        <br /><br />
                        <a href="/myweek/index.php?passkey=<?= $participant->registrationPassword ?>" class="btn-main-small">Back to myWeek</a>
                    <?
