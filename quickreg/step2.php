    	...
    	<div class="container">
        	<div class="row-fluid">
            	<div class="well span6 offset3 text-center sign-up">
                	<form id="signup" class="form-horizontal" method="post" action="/actions/quickreg/processStep2.php" onSubmit="saving = true;return checkForm(this);">
                    	<ul class="breadcrumb">
                        	<li class="active">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend">
                                    ...
                                    <input type="text" class="input-xlarge field-popover" id="dateOfBirth" name="dateOfBirth" placeholder="Select your date of birth" value="<?= $dateOfBirth ?>" required>
